...
import { requestEvalsQuery, verifyEvalsQuery } from './challenge.queries';
 ...
 */
const checkChallenge = (true_evals: any, answers: any) => {
  ...
  const allCorrect = answers.every((answer: any) => {
    const trueRating =
