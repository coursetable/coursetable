...
Deployments are automatically handled via GitHub Actions workflows (see [ci-cd.md](docs/ci-cd.md)).

For manual deployments and boostrapping a new server, see [how-to-deploy.md](docs/how-to-deploy.md).
