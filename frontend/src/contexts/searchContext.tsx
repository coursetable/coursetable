...
export function SearchProvider({
  ...
  const searchConfig = useMemo(() => {
    ...
    const processedCourseInfoAttributes = selectCourseInfoAttributes.map(
      (x) => x.label,
    );
    ...
    const searchVariables = {
      ...
      courseInfoAttributes: new Set(processedCourseInfoAttributes),
  ...
  useEffect(() => {
    if (
      ...
      !isEqual(selectCourseInfoAttributes, defaultOptions) ||
