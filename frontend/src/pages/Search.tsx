...
import { useSearch, Option, sortType, defaultFilters } from '../searchContext';
import {
  SurfaceComponent,
  StyledInput,
  StyledHr,
...
function Search() {
  ...
  const handleResetFilters = () => {
    ...
    setOverallBounds(defaultFilters.defaultOverallBounds);
    setWorkloadBounds(defaultFilters.defaultWorkloadBounds);
    setSelectSeasons(defaultFilters.defaultSeason);
