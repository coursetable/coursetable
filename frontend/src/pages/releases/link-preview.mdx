...
<img src="/images/release_notes/link-preview/link-preview-demo.png" alt="An example link preview, showing a Discord message containing a CourseTable course link. An embed is shown, containing the course title, description, and the CourseTable logo." width={600} />
...
<img src="/images/release_notes/link-preview/link-preview-orig.png" alt="A Discord message containing a CourseTable course link. The embed shows the generic title and description for the entire site instead of being specific to a course." width={600} />
...
<img src="/images/release_notes/link-preview/coursetable-arch-diagram.png" alt="Diagram showing CourseTable's architecture. The user's browser sends a GET request to Vercel, which returns HTML/JS/CSS. The JS then makes GET requests to the server, which returns JSON. JSON and HTML combined gets rendered in the browser and turns into the final UI." width={1000} />
...
<img src="/images/release_notes/link-preview/slack-generate-html.png" alt="Slack conversation between Alex and Sida. Alex proposes to generate HTML the first time it is requested, but doubts if it would still be crazy." width={600} />
...
<img src="/images/release_notes/link-preview/slack-vercel-function.png" alt='Slack conversation between Alex and Neil. Alex first proposes to add a serverless function so CourseTable is "able to render url previews when sending links of classes". The date was November 29th, 2023' width={800} />
...
<img src="/images/release_notes/link-preview/slack-vercel-conclusion.png" alt="Slack post of Sida, saying that Alex and him have huge resentments about the state of things, because the middleware gets executed for every req to `/catalog` / `/worksheet`, but actually we only do meaningful things if it's bot traffic, so 99.9% of the middleware usage is wasted" width={800} />
...
<img src="/images/release_notes/link-preview/slack-vercel-budget.png" alt="Slack conversation between Alex and Sida. Sida says that Vercel offers 1M/mo, while Alex says we are expecting 5M/mo max, so 10M/mo would be safer." width={800} />
...
<img src="/images/release_notes/link-preview/slack-neil-proposal.png" alt="Slack post of Neil, sharing a link to a cloudflare community discussion about redirecting search bots to another URL, and suggesting we should do this" width={800} />
...
<img src="/images/release_notes/link-preview/crawler-fail-redirect.png" alt='Screenshot of Facebook debugger console, displaying a warning that says "URL requested a HTTP redirect, but it could not be followed." for the CourseTable course URL.' width={1000} />
...
<img src="/images/release_notes/link-preview/slack-finding-logs.png" alt='Slack conversation between Alex and Sida. Sida asks why is the log empty? And then remarks "Are logs just a dream?"' width={800} />
...
<img src="/images/release_notes/link-preview/slack-success.png" alt='Slack post of Sida, saying "OHHHHHH" and posting a CourseTable course link' width={600} />
...
<img src="/images/release_notes/link-preview/slack-saved-money.png" alt='Slack post of Alex saying "now lets use that extra money we saved for our BARCELONA DINNER"' width={600} />

As promised, we are including all these funny Slack exchanges in this post, just to show you what we have been through:

<img src="/images/release_notes/link-preview/slack-slack-message.png" alt='Slack post of Alex, saying "all of these slack messages can be included in the blog when we finally get this"' width={800} />
...
<img src="/images/release_notes/link-preview/slack-merge-pr.png" alt="Conversation of Alex, Sida, and Neil. Sida says he's going to merge the PR because &quot;Can't test it except in prod&quot;. Alex says this should all be in a semi-technical blog post summarizing the ups and downs." width={800} />
