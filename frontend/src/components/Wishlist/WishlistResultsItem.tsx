...
import {
  ...
  CourseCode,
  ratingTypes,
} from '../Search/ResultsItemCommon';
import { TextComponent } from '../Typography';

import styles from './WishlistResultsItem.module.css';
import { generateRandomColor, type Listing } from '../../utilities/common';
import { isInWorksheet } from '../../utilities/course';
import { WishlistCourse } from '../../contexts/wishlistContext';
...
function WishlistResultsItem({
  course,
  numCols,
}: {
  readonly course: WishlistCourse;
...
export default WishlistResultsItem;
