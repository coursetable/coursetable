...
function CourseModal() {
  ...
  if (!curListing) return null;

  return (
    <div className="d-flex justify-content-center">
      <Helmet>
        <title>{curListing.course_code} - CourseTable</title>
        <meta property="og:title" content={curListing.title} />
        {curListing.description && (
          <meta property="og:description" content={curListing.description} />
        )}
      </Helmet>
      <StyledModal
      ...
      >
        <Modal.Header closeButton className="d-flex justify-content-between">
          ...
          <div className="align-self-center">
            <ShareButton courseCode={curListing.course_code} urlToShare={url} />
          </div>
        </Modal.Header>
        {listing &&
          (view === 'overview' ? (
