{*
	...
	Usage: popovers for containing the "Notice" page for bluebook
...
<div class="modal fade" id="notice" style="top: 5%; width: 800px; margin-left: -400px; left: 50%">
	...
	<div class="modal-body">
		...
		<img id="tutorial-image" src="/res/tutorial-0.png" alt="Guide to using YalePlus Bluebook" />
        <!--
        <p>As school starts, we're making YalePlus Bluebook better so that it can do everything you want it to do. On request, we have added:</p>
  ...
  <div class="modal-footer">
    ...
    <a href="#" id="tutorial-button-2" class="btn btn-success" data-dismiss="modal" style="display: none">Take me to the Bluebook</a>  
  </div>
</div>
